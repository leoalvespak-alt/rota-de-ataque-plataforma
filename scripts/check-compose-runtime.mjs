...
const requiredServices = ['editorial-redis', 'prospector-migrate', 'prospector-web', 'design-migrate', 'design-api', 'design-web', 'editorial-caddy']
...
console.log('Fase 7 compose covers Prospector, Design, Caddy and Redis with native PostgreSQL/PgBouncer endpoints.')
