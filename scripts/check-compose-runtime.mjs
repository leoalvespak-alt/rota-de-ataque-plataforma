...
if (!workerEntrypoint.includes('exec node --import tsx --enable-source-maps "$worker_main"')) throw new Error('Worker entrypoint must exec one Node process with the tsx loader while workspace exports reference TypeScript source')
