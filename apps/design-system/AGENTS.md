...
Consulte `../../../docs/ARQUITETURA_FINAL.md` antes de tarefas grandes. Após alterações estruturais, revise o documento canônico e, se a integração entre produtos mudar, atualize a documentação em `../../../docs/`.
