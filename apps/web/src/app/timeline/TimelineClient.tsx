...
export interface TimelineRow { id: string; channel: string; eventType: string; at: string; source: string; correlation: string | null; campaign: string | null }
